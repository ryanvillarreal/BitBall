...
while True:
        ...
        teams=['Aave Ghosts','Alchemix Conjurers','Abracadabra Wizards','Olympus Omegas','Uniswap Unicorns','Convex Curves','Compound Dragons','Chainlink Frogs','Rari Whales','Fractional NFT']
        randomize = 0
