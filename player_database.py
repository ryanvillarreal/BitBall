...
c.execute("INSERT INTO captains VALUES ('Fractional NFT','Shiva Moss')")

c.execute("INSERT INTO captains VALUES ('Rari Whales','Ptolemy Crass')")

c.execute("INSERT INTO captains VALUES ('Chainlink Frogs','Sylvia Trask')")

c.execute("INSERT INTO captains VALUES ('Compound Dragons','Horus Shelp')")

c.execute("INSERT INTO captains VALUES ('Convex Curves','Bandy Moscato')")

c.execute("INSERT INTO captains VALUES ('Uniswap Unicorns','Igor Rendón')")

c.execute("INSERT INTO captains VALUES ('Olympus Omegas','Helias King')")

c.execute("INSERT INTO captains VALUES ('Abracadabra Wizards','Mogan Squip')")

c.execute("INSERT INTO captains VALUES ('Alchemix Conjurers','Tel''blort')")

c.execute("INSERT INTO captains VALUES ('Aave Ghosts','Gobro Gons')")
